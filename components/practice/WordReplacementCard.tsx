...
export function WordReplacementCard({
  ...
  return (
    <div className="rounded-2xl border border-white/60 bg-white/36 p-4 dark:border-white/12 dark:bg-white/5">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <button
          ...
          className={cn(
            ...
            isSaved
              ? "bg-emerald-400/16 text-emerald-900 dark:text-emerald-100"
