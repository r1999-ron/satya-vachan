  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#f8f5ef] text-ink dark:bg-zinc-950 dark:text-zinc-50">
      <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute right-[-16rem] top-1/3 h-[34rem] w-[34rem] rounded-full bg-amber-100/35 blur-3xl dark:bg-amber-500/8" />
      ...
      <Header />
      <main className="mx-auto w-full max-w-6xl px-4 pb-[calc(6.75rem+env(safe-area-inset-bottom))] pt-4 motion-safe:animate-pageIn sm:px-6 md:pb-16 md:pt-9">
        {children}
      </main>
      <BottomNav />
    </div>
